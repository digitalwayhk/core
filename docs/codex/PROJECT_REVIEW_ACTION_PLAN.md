...
| 12. 请求隔离、全局状态与生命周期 | 进行中（12.1-12.6 已完成） | `60b6e3a`, `fc42ae7`, `52ac181`, `87cc800`, `b816515`, `ffe27c8`, `f016173` | 请求与注册表已隔离，Membership/ServiceContext 及 REST/HTML/WebServer 关闭已幂等可等待；待完成 Provider 对账和泄漏门禁 |
