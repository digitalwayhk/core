...
| 18. PrefixedBadgerDB 可靠写回 | 已完成 | `ef8f0cd`, `a3b7b3d`, `c514662`, `cd11919`, `cf5eecd` | 损坏默认 fail closed、可靠配置绑定、pending TTL 拒绝、Set/BatchInsert/Delete 唯一索引计数、损坏项保留和关闭积压错误均有单元/race 契约 |
