...
| 11. Security baseline and authentication isolation | In progress (post-review A-B complete) | `804a2de`, `937d381`, `daa2c57`, `5e4bcd8`, `503a01d`, `0bc1a14`, `3f4f506`, `e320017` | Local forwarding spoofing, Logto identity binding, and nil Request handling pass; docs/examples, test mode, and JWKS lifecycle decision remain |
