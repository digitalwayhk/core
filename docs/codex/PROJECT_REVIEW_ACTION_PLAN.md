...
| 11. Security baseline and authentication isolation | In progress (11.1 complete) | `a8f1c0d`, `804a2de` | Config writes and migrations are verified as `0600`; auth isolation, proxy/CORS policy, and safe-response sections remain |
