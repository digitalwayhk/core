...
| 认证 private API | `api/private`、`req.GetUser()`、`api/dto` | `examples/01-simple-shop/api/private` | 框架 JWT；外部身份使用每服务 Casdoor；代理部署配置 `TrustedProxies` | `go test ./examples/integration/01-simple-shop -run Private` | Stable |
