...
func testRejectEnablingProductForDisabledSupplier(t *testing.T) {
	...
	enabled := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/productmanage/enablebasedata", admin, map[string]interface{}{"id": product.ID})
...
func testSupplierCRUDAndReadOnlyProducts(t *testing.T) {
	...
	view := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/view", token, nil)
	...
	childSearch := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/search", token, map[string]interface{}{
	...
	edited := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/edit", token, map[string]interface{}{
	...
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/remove", token, map[string]interface{}{"id": supplier.ID})
	...
	removed = suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/remove", token, map[string]interface{}{"id": removable.ID})
...
func testRejectRemovingUsedSupplier(t *testing.T) {
	...
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/suppliermanage/remove", admin, map[string]interface{}{"id": supplier.ID})
	assert.False(t, removed.Success)
	assert.Contains(t, removed.ErrorMessage, "供应商已有商品")
}
...
func testProductCRUD(t *testing.T) {
	...
	view := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/productmanage/view", token, nil)
	require.True(t, view.Success, view.ErrorMessage)
	product := suite.AddProduct(t, token, fmt.Sprintf("管理商品-%d", time.Now().UnixNano()), "10.00")
	edited := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/productmanage/edit", token, map[string]interface{}{
		"id": product.ID, "code": product.Code, "name": product.Name + "-改", "price": "12.00", "supplierID": product.SupplierID, "enabled": true,
	})
	require.True(t, edited.Success, edited.ErrorMessage)
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/productmanage/remove", token, map[string]interface{}{"id": product.ID})
	require.True(t, removed.Success, removed.ErrorMessage)
}
...
func testRejectRemovingUsedProduct(t *testing.T) {
	...
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/productmanage/remove", admin, map[string]interface{}{"id": product.ID})
	assert.False(t, removed.Success)
...
func testPaymentTypeCRUDAndStateCommands(t *testing.T) {
	...
	enabled := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/enablebasedata", admin, map[string]interface{}{"id": item.ID})
	require.True(t, enabled.Success, enabled.ErrorMessage)
	disabled := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/disablebasedata", admin, map[string]interface{}{"id": item.ID})
	require.True(t, disabled.Success, disabled.ErrorMessage)

	edited := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/edit", admin, map[string]interface{}{
		"id": item.ID, "code": item.Code, "name": "测试支付已修改", "enabled": false, "description": "新说明",
	})
	require.True(t, edited.Success, edited.ErrorMessage)
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/remove", admin, map[string]interface{}{"id": item.ID})
	require.True(t, removed.Success, removed.ErrorMessage)
}
...
func testRejectRemovingUsedPaymentType(t *testing.T) {
	...
	removed := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/remove", admin, map[string]interface{}{"id": typeItem.ID})
	assert.False(t, removed.Success)
	assert.Contains(t, removed.ErrorMessage, "支付类型已被支付流水使用")

	changedCode := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymenttypemanage/edit", admin, map[string]interface{}{
...
func testOrderManageReadOnly(t *testing.T) {
	...
	view := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/ordermanage/view", admin, nil)
	require.True(t, view.Success, view.ErrorMessage)
	assert.Contains(t, string(view.Data), "支付状态")
	for _, command := range []string{"add", "edit", "remove"} {
		response := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/ordermanage/"+command, admin, map[string]interface{}{})
...
func testPaymentRecordCommands(t *testing.T) {
	...
	cancelled := suite.RequestJSON(t, http.MethodPost, "/api/performanceshop/cancelorder", user, map[string]interface{}{"id": order.ID})
	...
	search := suite.RequestJSON(t, http.MethodPost, "/api/manage/performanceshop/paymentrecordmanage/search", admin, map[string]int{"page": 1, "size": 100})
