...
func (s *shopSuite) AddProductForSupplier(t *testing.T, token, code, name, price string, supplierID uint, enabled bool) ProductDTO {
	t.Helper()
...
func (s *shopSuite) AddSupplier(t *testing.T, token, code, name string, enabled bool) SupplierDTO {
	t.Helper()
...
func (s *shopSuite) SetBaseDataEnabled(t *testing.T, token, manageName, id string, enabled bool) {
	t.Helper()
