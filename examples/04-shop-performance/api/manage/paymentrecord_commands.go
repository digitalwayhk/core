...
func NewConfirmPayment(instance interface{}, service *business.PaymentService) *ConfirmPayment {
	return &ConfirmPayment{Operation: managepkg.NewOperation[models.PaymentRecord](instance), service: service}
}

// New 为请求创建独立命令实例。
func (own *ConfirmPayment) New(instance interface{}) servertypes.IRouter {
	return NewConfirmPayment(instance, own.service)
}
...
func (own *ConfirmPayment) Do(servertypes.IRequest) (interface{}, error) {
	change, err := own.service.ConfirmPayment(own.Model.ID)
	if err != nil {
		return nil, err
	}
...
func NewFailPayment(instance interface{}, service *business.PaymentService) *FailPayment {
	return &FailPayment{Operation: managepkg.NewOperation[models.PaymentRecord](instance), service: service}
}

// New 为请求创建独立命令实例。
func (own *FailPayment) New(instance interface{}) servertypes.IRouter {
	return NewFailPayment(instance, own.service)
}
...
func (own *FailPayment) Do(servertypes.IRequest) (interface{}, error) {
	change, err := own.service.FailPayment(own.Model.ID)
	if err != nil {
		return nil, err
	}
	return privateapi.NotifyOrderChange(change.Action, change.Order), nil
...
func NewConfirmRefund(instance interface{}, service *business.PaymentService) *ConfirmRefund {
	return &ConfirmRefund{Operation: managepkg.NewOperation[models.PaymentRecord](instance), service: service}
}

// New 为请求创建独立命令实例。
func (own *ConfirmRefund) New(instance interface{}) servertypes.IRouter {
	return NewConfirmRefund(instance, own.service)
}
...
func (own *ConfirmRefund) Do(servertypes.IRequest) (interface{}, error) {
	change, err := own.service.ConfirmRefund(own.Model.ID)
	if err != nil {
		return nil, err
	}
	return privateapi.NotifyOrderChange(change.Action, change.Order), nil
