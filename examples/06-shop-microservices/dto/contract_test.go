...
func TestSharedDTOsKeepStableJSONFields(t *testing.T) {
	...
	assert.JSONEq(t, `{"id":0,"userID":"buyer-1","product":{"productID":0,"supplierID":"","supplierName":"","productCode":"","productName":"","unitPrice":"0"},"address":{"addressID":0,"recipient":"","phone":"","region":"","detail":""},"quantity":0,"totalAmount":"0","paymentStatus":0,"status":0,"createdAt":"0001-01-01T00:00:00Z"}`, string(data))
}
