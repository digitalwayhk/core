// Package basedata 提供 07 供应商服务基础资料 Manage 基座。
package basedata

import (
	commonmanage "github.com/digitalwayhk/core/examples/07-shop-order-scale/supplier-service/api/manage/common"
	persistencetypes "github.com/digitalwayhk/core/pkg/persistence/types"
)

// BaseDataManage 是 supplier-service 基础资料 Manage 的抽象基座。
